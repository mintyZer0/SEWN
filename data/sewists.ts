...
export const sewistsData: Sewist[] = [
  {
    id: "1",
    name: "Maria Santos",
    ...
    rating: 4.8,
    image: "/assets/sewist-photos/1.png",
    servicesOffered: ["repair", "alteration", "commission"],
...
export function getSewistById(id: string): Sewist | undefined {
  return sewistsData.find((sewist) => sewist.id === id);
}
