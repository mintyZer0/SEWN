...
export function AdminLoginForm({
  ...
  return (
    <div
      ...
      {...props}
    >
      <Card className="text-primary h-auto md:h-200 w-full md:w-150 border-0 shadow-none bg-white p-4 md:p-8">
        <CardHeader className="flex flex-col items-center gap-2 text-center">
          <CardTitle className="text-5xl md:text-8xl font-normal text-primary">Admin Login</CardTitle>
          <CardDescription className="text-lg md:text-2xl text-primary/70">
          ...
          <form>
            <div className="flex flex-col gap-4 md:gap-6">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  className="rounded-xl md:rounded-2xl text-base md:text-lg! h-12 md:h-16! px-4! py-4! border-primary/20 focus-visible:ring-primary"
                  id="email"
                  name="email"
                  type="email"
              ...
              <Button
                ...
                className="w-full h-14 md:h-20 rounded-2xl md:rounded-3xl bg-primary text-white text-2xl md:text-4xl font-semibold shadow-md hover:bg-primary-dark transition-all active:scale-95 cursor-pointer mt-2 md:mt-0"
              >
                LOGIN
              </Button>
            </div>
