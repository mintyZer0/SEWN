      ...
      >
            ...
            {DAYS.map((day) => {
              ...
              return (
                <button
                  ...
                  className={`relative z-10 flex-1 py-3 text-xs font-medium transition-all active:scale-95 ${isActive ? 'text-gray-900' : 'text-gray-400'}`}
                >
                  {isActive && (
                    <motion.div
                  ...
                  <AnimatePresence mode="wait">
                    {isActive ? (
                      ...
                      <motion.div 
                        ...
                        exit={{ opacity: 0, y: -10 }}
                        transition={{ duration: 0.2 }}
                        className="py-12 flex flex-col items-center justify-center bg-gray-50 rounded-2xl border border-dashed border-gray-200"
                      >
        ...
        <div className="p-8 border-t border-gray-100 bg-gray-50 flex justify-end">
          <PrimaryButton 
            onClick={handleSave} 
            disabled={saving} 
            className="flex items-center gap-2 px-8 active:scale-95 transition-all"
          >
