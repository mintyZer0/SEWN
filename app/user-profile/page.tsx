      ...
      <div className="bg-white rounded-[30px] p-10 flex flex-col lg:flex-row gap-16 shadow-lg border border-white/20">
        <div className="flex-1 space-y-8">
          ...
          <div className="grid grid-cols-[140px_1fr] items-center gap-y-6 gap-x-4">
            <label className="text-xl font-medium text-gray-800">Username:</label>
            <input 
              type="text" 
              name="username"
            ...
            <div className="flex gap-8 text-third">
              {['Male', 'Female', 'Other'].map((option) => (
                <label key={option} className={`flex items-center gap-2.5 ${isEditing ? 'cursor-pointer group' : 'cursor-default'}`}>
                  <input 
                    type="radio" 
                    name="gender" 
                  ...
                  /> 
                  <span className={`text-lg ${isEditing ? 'group-hover:text-third/80' : ''} transition-colors`}>{option}</span>
                </label>
              ))}
            </div>

            <label className="text-xl font-medium text-gray-800">Date of birth:</label>
            <input 
              type="date" 
              name="dob"
              value={formData.dob}
            ...
            <label className="text-xl font-medium text-gray-800">Addresses:</label>
            <button 
              disabled={!isEditing}
