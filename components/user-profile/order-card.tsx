    ...
    <div className="bg-white rounded-[35px] p-6 md:p-8 shadow-lg overflow-hidden">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 pb-4 border-b border-third/30">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <button className="flex-1 md:flex-none px-6 py-2 bg-third text-white rounded-full font-semibold text-sm hover:opacity-90 transition-opacity">
            Chat with Sewer
          </button>
          <button className="flex-1 md:flex-none px-6 py-2 bg-third text-white rounded-full font-semibold text-sm hover:opacity-90 transition-opacity">
            View Sewer
        ...
        <div className="w-full md:w-auto">
          {order.canConfirmReceipt ? (
            <div className="flex items-center gap-4">
              ...
              <button className="px-8 py-2 bg-third text-white rounded-full font-bold text-lg hover:opacity-90 transition-opacity">
                Confirm Delivery
              </button>
            </div>
          ) : (
