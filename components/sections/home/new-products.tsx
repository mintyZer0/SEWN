...
export default function NewProducts() {
  ...
  return (
    <>
      ...
      <div className="hidden md:flex justify-center h-auto w-auto lg:mx-12 m-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-x-12 w-full max-w-7xl">
