    ...
    <div className="w-full pt-30 pb-20 px-4 md:px-8 bg-gradient-to-b from-transparent to-primary">
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <form
          ...
          className="flex w-full max-w-lg bg-white rounded-2xl p-1 mb-8"
        >
          <input
            type="email"
            placeholder="enter your email address"
            className="flex-1 px-6 py-3 bg-transparent text-gray-800 placeholder:text-gray-400 focus:outline-none"
            value={email}
          ...
          <button
            type="submit"
            className="px-8 py-3 bg-gradient-to-r from-[#FF975E] to-[#FFCFB1] text-[#7B3B7B] font-bold rounded-xl hover:opacity-90 transition-opacity"
          >
            Subscribe
          </button>
        </form>
