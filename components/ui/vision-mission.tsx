  ...
  return (
    <div className="h-150">
      <div className="grid grid-cols-2 grid-rows-2 gap-20 p-25 place-items-center">
        <div className="flex flex-col text-7xl text-center p-4 py-6 gap-4 h-40 w-140">
        ...
        <div className="flex flex-col text-7xl text-center p-4 py-6 gap-4 h-40 w-140 col-span-2">
